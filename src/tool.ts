...
export default class Tool {
    ...
    private children: Array<ToolItem> = [
        { type: "rect", title: "矩形工具", dom: document.createElement("div"), option: { size: CommonSize.SMALL, color: "black" } },
        { type: "ellipse", title: "椭圆工具", dom: document.createElement("div"), option: { size: CommonSize.SMALL, color: "black" } },
        { type: "arrow", title: "箭头工具", dom: document.createElement("div"), option: { size: CommonSize.SMALL, color: "black" } },
        { type: "brush", title: "画笔工具", dom: document.createElement("div"), option: { size: CommonSize.SMALL, color: "black" } },
        { type: "text", title: "文字工具", dom: document.createElement("div"), option: { size: TextSize.SMALL, color: "black" } },
